...
const consoleEditSeries = {
  ...
  LABEL_NOT_FOUND_HEADER:
    'Naku, hindi namin mahanap ang seryeng ito para i-edit',
  LABEL_NOT_FOUND_MSG_1:
    'Kung sa tingin mo ay umiiral ang epico series na ito, mangyaring makipag-ugnayan sa aming suporta gamit ang ibinigay na series ID',

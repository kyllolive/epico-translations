...
const translate = { ...topNav,
  ...
  SCANLATE_BANNER_CONTENT: 'Apoye a los creadores ayudándolos a llegar a un mercado más amplio Obtenga acceso a todos los cómics de forma gratuita Trabaje con los creadores en un entorno legal Búsqueda de diálogo/manuscrito Glosario incorporado para cambiar de equipo',

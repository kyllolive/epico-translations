...
const translate = { ...topNav,
  ...
  SCANLATE_BANNER_CONTENT: 'Dukung pembuat konten dengan membantu mereka menjangkau pasar yang lebih besar Dapatkan akses ke semua komik secara gratis Bekerja dengan pembuat konten dalam pengaturan hukum Dialog/manuskrip yang dapat ditelusuri Glosarium bawaan untuk mengubah tim',

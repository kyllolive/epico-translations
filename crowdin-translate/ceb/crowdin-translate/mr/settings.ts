...
const settings = { ...topNav,
  ...
  LABEL_CHANGE_PASSWORD_LIMIT_EXCEEDED_MSG: 'मर्यादा ओलांडली आहे कृपया नंतर पुन्हा प्रयत्न करा',
  LABEL_CHANGE_PASSWORD_UNABLE_TO_PROCESS: 'तुमच्या विनंतीवर प्रक्रिया करण्यात अक्षम',
  ...
  LABEL_CHANGE_USERNAME_SUCCESS_MSG: 'तुमचे वापरकर्तानाव यशस्वीरित्या अपडेट केले गेले',
  FORM_VALIDATION_USERNAME_MATCHES: 'क्षमस्व, फक्त लहान अक्षरे (a-z), संख्या (0-9), विशेष वर्ण (.-_) कोणत्याही जागेची परवानगी नाही.',
  ...
  LABEL_CURRENCY: 'तुम्हाला तुमच्या समर्थकांनी द्यायचे असलेले चलन निवडा. तुमचे घर चलन सूचीबद्ध नसल्यास, तुमचा पेमेंट प्रदाता ते तुमच्यासाठी आपोआप रूपांतरित करेल.',
  LABEL_MIN_DONATION_HEADER: 'देणगीची किमान किंमत सेट करा',
  LABEL_THANK_YOU_MESSAGE_HEADER: 'ऑटो धन्यवाद संदेश',
  LABEL_THANK_YOU: 'कोणी दान केल्यावर पाठवायचा संदेश. तुम्हाला वैयक्तिक पाठवण्याचीही संधी मिळेल.',
  ...
  LABEL_VERIFY_PAYPAL: 'कृपया ऑनबोर्डिंग पूर्ण करण्यासाठी आणि पेमेंट स्वीकारण्यास प्रारंभ करण्यासाठी Paypal द्वारे तुम्हाला पाठवलेल्या ईमेलची पडताळणी करा.',
  LABEL_PAYPAL: 'पेपल इतर वापरकर्त्यांकडून देणग्या प्राप्त करण्यासाठी कनेक्ट केलेले असणे आवश्यक आहे!',
  LABEL_DISAGREE: 'असहमत',
  LABEL_AGREE: 'सहमत',
  LABEL_SETTINGS_LANGUAGE: 'सेटिंग्ज भाषा',
  LABEL_PAYMENT_ENABLED: 'सक्षम केले',
  LABEL_PAYMENT_DISABLED: 'अक्षम',
  LABEL_ACCEPT_DESCRIPTION: 'क्रेडिट कार्ड आणि PayPal शिल्लक स्वीकारा. तुमच्या PayPal वर त्वरित पैसे दिले.'
};

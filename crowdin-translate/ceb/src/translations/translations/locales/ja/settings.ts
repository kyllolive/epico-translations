...
const settings = { ...topNav,
  ...
  LABEL_CHANGE_PASSWORD_LIMIT_EXCEEDED_MSG: '制限を超えました。しばらくしてからもう一度お試しください',
  ...
  FORM_VALIDATION_USERNAME_MATCHES: '申し訳ありませんが、小文字 (a-z)、数字 (0-9)、特殊文字 (.-_) のみ使用できます。スペースは使用できません。',
  ...
  LABEL_CURRENCY: 'サポーターに支払う通貨を選択します。自国の通貨がリストにない場合は、支払いプロバイダーが自動的に換算します。',
  LABEL_MIN_DONATION_HEADER: '最低寄付額を設定する',
  LABEL_THANK_YOU_MESSAGE_HEADER: '自動お礼メッセージ',
  LABEL_THANK_YOU: '誰かが寄付したときに送信されるメッセージ。個人的なものを送る機会もあります。',
  LABEL_SUBMIT_PAYMENT_SETTING: '送信',
  FORM_VALIDATION_THANK_YOU: 'サポートありがとうございます',
  FORM_VALIDATION_UPDATE_SUCCESS: '寄付の設定が正常に更新されました。',
  LABEL_VERIFY_PAYPAL: 'オンボーディングを完了し、支払いの受け入れを開始するには、Paypal から送信されたメールを確認してください。',
  LABEL_PAYPAL: '他のユーザーから寄付を受け取るには、Paypal に接続する必要があります。',
  LABEL_DISAGREE: '同意しない',
  LABEL_AGREE: '同意',
  LABEL_SETTINGS_LANGUAGE: '設定言語',
  LABEL_PAYMENT_ENABLED: '有効',
  LABEL_PAYMENT_DISABLED: '無効',
  LABEL_ACCEPT_DESCRIPTION: 'クレジット カードと PayPal の残高を受け入れます。あなたのPayPalに即座に支払われます。'
};

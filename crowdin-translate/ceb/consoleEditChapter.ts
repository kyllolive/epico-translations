...
const consoleEditChapter = {
  ...
  LABEL_NOT_FOUND_HEADER:
    'Uh oh, wala namo makit-an kini nga kapitulo para i-edit',
  LABEL_NOT_FOUND_MSG_1:
    'Kung sa imong hunahuna adunay kini nga epico nga kapitulo palihug kontaka ang among suporta sa gihatag nga serye nga ID',

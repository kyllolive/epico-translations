...
const settings = { ...topNav,
  ...
  FORM_VALIDATION_OLD_PASSWORD_REQUIRED: 'Kinakailangan ang kasalukuyang password',
  ...
  LABEL_CHANGE_PASSWORD_SUCCESS_MSG: 'Matagumpay na na-update ang iyong password',
  LABEL_CHANGE_PASSWORD_INCORRECT_PASSWORD_MSG: 'Maling password',
  LABEL_CHANGE_PASSWORD_LIMIT_EXCEEDED_MSG: 'Lumampas sa limitasyon, pakisubukang muli sa ibang pagkakataon',
  LABEL_CHANGE_PASSWORD_UNABLE_TO_PROCESS: 'Hindi maproseso ang iyong kahilingan',
  ...
  LABEL_CHANGE_USERNAME_SUCCESS_MSG: 'Ang iyong username ay matagumpay na na-update',
  FORM_VALIDATION_USERNAME_MATCHES: 'Paumanhin, maliliit na letra lamang (a-z), numero (0-9), mga espesyal na character (.-_) walang puwang ang pinapayagan.',
  ...
  LABEL_CURRENCY: 'Piliin ang currency na gusto mong bayaran ng iyong mga tagasuporta. Kung hindi nakalista ang iyong pera sa bahay, awtomatikong iko-convert ito ng iyong provider ng pagbabayad para sa iyo.',
  ...
  LABEL_THANK_YOU: 'Isang mensahe na ipapadala kapag may nag-donate. Magkakaroon ka rin ng pagkakataong magpadala ng personal.',
  LABEL_SUBMIT_PAYMENT_SETTING: 'Ipasa',
  FORM_VALIDATION_THANK_YOU: 'maraming salamat sa iyong suporta',
  FORM_VALIDATION_UPDATE_SUCCESS: 'Matagumpay na na-update ang mga setting ng donasyon!',
  LABEL_VERIFY_PAYPAL: 'Paki-verify ang email na ipinadala sa iyo ng Paypal upang makumpleto ang onboarding at simulan ang pagtanggap ng mga pagbabayad.',
  LABEL_PAYPAL: 'Dapat na konektado ang Paypal para makatanggap ng mga donasyon mula sa ibang mga user!',
  ...
  LABEL_ACCEPT_DESCRIPTION: 'Tanggapin ang mga credit card at balanse sa PayPal. Agad na binayaran sa iyong PayPal.'
};

...
const profile = { ...donationBox,
  ...
  LABEL_SUCCESS_UPDATE_PROFILE: 'Nagmalampuson kami sa pag-update sa imong profile',
  ...
  LABEL_UPDATE_PROFILE_INFORMATION: 'Dali nga pag-update sa impormasyon sa profile',

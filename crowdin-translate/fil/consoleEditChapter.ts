...
const consoleEditChapter = {
  ...
  LABEL_NOT_FOUND_HEADER:
    'Uh oh, hindi namin mahanap ang kabanatang ito para i-edit',
  LABEL_NOT_FOUND_MSG_1:
    'Kung sa tingin mo ay umiiral ang epico chapter na ito, mangyaring makipag-ugnayan sa aming suporta gamit ang ibinigay na series ID',

...
const profile = { ...donationBox,
  ...
  LABEL_UNABLE_SAVE_CHANGES: 'Uh oh! Hindi namin nai-save ang iyong mga pagbabago',
  LABEL_ADD_ANOTHER: 'Magdagdag ng Isa pa',
  LABEL_EDIT_PROFILE: 'Ibahin ang profile',
  LABEL_JOINED_DATE: 'Petsa ng pagsali',
  LABEL_UPDATE_PROFILE_INFORMATION: 'Mabilis na i-update ang impormasyon ng profile',

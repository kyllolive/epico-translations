...
const translate = { ...topNav,
  ...
  SCANLATE_BANNER_CONTENT: 'Soutenez les créateurs en les aidant à atteindre un marché plus large Accédez gratuitement à toutes les bandes dessinées Travaillez avec les créateurs dans un cadre légal Dialogue/manuscrit consultable Glossaire intégré pour les équipes changeantes',
  SCANLATE_BANNER_HEADER_2: "Vos bandes dessinées méritent d'être lues par le monde",
  ...
  LABEL_HOW_TO_COMMENT_2: 'Faites glisser pour mettre en surbrillance la zone souhaitée',
  LABEL_HOW_TO_COMMENT_3: 'Cliquez sur la zone de texte indiquant Rédiger un commentaire, saisissez votre commentaire, puis cliquez sur Soumettre.',
  //Description Tab
  ...
  //Change
  LABEL_CHANGE_PAGE: 'Il y a des modifications non enregistrées. Êtes-vous sûr de vouloir déménager ? Les modifications seront perdues'
};

...
const consoleEditChapter = {
  ...
  LABEL_SINGLE_CHAPTER_COVER_SUB:
    'सभी उपकरणों पर सर्वोत्तम परिणामों के लिए, कम से कम 360 x 360 पिक्सेल वाली छवि का उपयोग करें',
  ...
  LABEL_NOT_FOUND_HEADER:
    'उह ओह, हम इस अध्याय को संपादन के लिए खोजने में असमर्थ थे',
  LABEL_NOT_FOUND_MSG_1:
    'यदि आपको लगता है कि यह महाकाव्य अध्याय मौजूद है तो कृपया दी गई श्रृंखला आईडी के साथ हमारे समर्थन से संपर्क करें',

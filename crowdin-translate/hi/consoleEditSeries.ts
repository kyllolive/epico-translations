...
const consoleEditSeries = {
  ...
  LABEL_SINGLE_COVER_SUB:
    'सभी उपकरणों पर सर्वोत्तम परिणामों के लिए, ऐसी छवि का उपयोग करें जो कम से कम 600 x 400 पिक्सेल की हो',
  ...
  LABEL_NOT_FOUND_HEADER:
    'उह ओह, हम इस श्रृंखला को संपादन के लिए नहीं ढूंढ पाए',
  LABEL_NOT_FOUND_MSG_1:
    'यदि आपको लगता है कि यह महाकाव्य श्रृंखला मौजूद है तो कृपया दी गई श्रृंखला आईडी के साथ हमारे समर्थन से संपर्क करें',
  LABEL_NOT_FOUND_MSG_2: 'भाषा आईडी के साथ',
  LABEL_MAX_GENRES: 'आप 3 शैलियों तक चुन सकते हैं',
  LABEL_OPTIONAL_TAG_ERROR_MESSAGE:
    'एक आरक्षित शब्द है, इसका उपयोग नहीं किया जा सकता है!',

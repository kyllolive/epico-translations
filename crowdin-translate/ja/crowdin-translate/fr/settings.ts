...
const settings = { ...topNav,
  ...
  LABEL_CHANGE_PASSWORD_SUCCESS_MSG: 'Votre mot de passe a été mis à jour avec succès',
  LABEL_CHANGE_PASSWORD_INCORRECT_PASSWORD_MSG: 'Mot de passe incorrect',
  LABEL_CHANGE_PASSWORD_LIMIT_EXCEEDED_MSG: 'Limite dépassée veuillez réessayer plus tard',
  LABEL_CHANGE_PASSWORD_UNABLE_TO_PROCESS: 'Impossible de traiter votre demande',
  ...
  LABEL_CHANGE_USERNAME_SUCCESS_MSG: "Votre nom d'utilisateur a été mis à jour avec succès",
  FORM_VALIDATION_USERNAME_MATCHES: 'Désolé, seules les lettres minuscules (a-z), les chiffres (0-9), les caractères spéciaux (.-_) sans espace sont autorisés.',
  ...
  LABEL_THANK_YOU: "Un message à envoyer lorsque quelqu'un fait un don. Vous aurez également la possibilité d'en envoyer un personnel.",
  ...
  LABEL_VERIFY_PAYPAL: "Veuillez vérifier l'e-mail qui vous a été envoyé par Paypal pour terminer l'intégration et commencer à accepter les paiements.",
  LABEL_PAYPAL: 'Paypal doit être connecté pour recevoir les dons des autres utilisateurs !',
  ...
  LABEL_ACCEPT_DESCRIPTION: 'Acceptez les cartes de crédit et le solde PayPal. Payé sur votre PayPal instantanément.'
};

...
const dashboard = { ...topNav,
  ...
  LABEL_UPLOAD_SERIES_DESCRIPTION: 'Ajoutez des travaux récents à votre galerie',
  ...
  LABEL_ABOUT_ME_DESCRIPTION: 'Faites savoir à tout le monde de quoi vous parlez.',

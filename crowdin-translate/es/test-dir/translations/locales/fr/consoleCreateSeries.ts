...
const consoleCreateSeries = { ...genres,
  ...
  // END FORM VALIDATION
  LABEL_SINGLE_BANNER_DROPBOX: 'Déposez votre bannière ici ou cliquez pour parcourir.',
  LABEL_SINGLE_COVER_DROPBOX: 'Déposez votre photo de couverture ici ou cliquez pour parcourir.',
  LABEL_SINGLE_CHAPTER_COVER: 'Déposez votre photo de couverture ici ou cliquez pour parcourir.',

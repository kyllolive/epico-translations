...
const home = {
  ...
  LABEL_ABOUT_US_BODY_5_2:
    'También creemos que los grandes cómics pueden provenir de cualquier parte.',
  LABEL_ABOUT_US_BODY_5_3:
    'We are a group of comic fans determined to build tools',
  LABEL_ABOUT_US_BODY_5_4:
    'para ayudar a los creadores de historietas a conectar sus historias con tantas personas como sea posible.',
